...
for "_i" from 1 to 4 do {player addItemToVest "rhsusf_100rnd_556x45_m855_soft_pouch";};
for "_i" from 1 to 3 do {player addItemToVest "UK3CB_BAF_9_15Rnd";};
for "_i" from 1 to 2 do {player addItemToVest "rhs_mag_m67";};
for "_i" from 1 to 2 do {player addItemToVest "SmokeShell";};
player addBackpack "FGN_AAF_FAST_Multicam";
for "_i" from 1 to 4 do {player addItemToBackpack "rhsusf_100rnd_556x45_m855_soft_pouch";};
