...
player addWeapon "UK3CB_BAF_L91A1";
player addPrimaryWeaponItem "UK3CB_BAF_9_30Rnd";
player addWeapon "UK3CB_BAF_L9A1";
player addHandgunItem "UK3CB_BAF_9_13Rnd";
...
for "_i" from 1 to 2 do {player addItemToVest "UK3CB_BAF_9_13Rnd";};
for "_i" from 1 to 2 do {player addItemToVest "UK3CB_BAF_9_30Rnd";};
...
player addItemToBackpack "UK3CB_H_Crew_Helmet";
