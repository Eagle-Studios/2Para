...
for "_i" from 1 to 6 do {player addItemToBackpack "UK3CB_BAF_1Rnd_HE_Grenade_Shell";};
for "_i" from 1 to 6 do {player addItemToBackpack "UK3CB_BAF_1Rnd_HEDP_Grenade_Shell";};
